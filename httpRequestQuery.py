import requests
import time
import hostPortSniffing
import os
from pathlib import Path, PureWindowsPath

file = PureWindowsPath("C:\\Users\\LI252\\PycharmProjects\\servicesniffer\\" + hostPortSniffing.reportName)
reportPath = Path(file)

f = open(reportPath, 'rt')
rows = f.read()
print(reportPath)
